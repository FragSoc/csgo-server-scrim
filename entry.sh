...
if [ ! -f "${STEAMAPPDIR}/${STEAMAPP}/cfg/server.cfg" ];
	then
		...
		# Download get5
		wget -O latest-get5.zip https://ci.splewis.net/job/get5/lastSuccessfulBuild/artifact/builds/get5/get5-520.zip
...
# Replace current server.cfg with template file and import match.cfg
cp -r custom_server_template.cfg "${STEAMAPPDIR}/${STEAMAPP}/cfg/server.cfg"
cp -r match.cfg "${STEAMAPPDIR}/${STEAMAPP}/match.cfg"
